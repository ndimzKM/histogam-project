        ...
        <div className="w-11/12 max-w-[699px] px-10 py-20 rounded-3xl bg-white border-2 border-gray-100">
            ...
            <div className="mt-8">
                ...
                <div className="mt-8 flex flex-col gap-y-4">
                    <button onClick={handleSubmit} className="active:scale-[.98] active:duration-75 transition-all hover:scale-[1.01]  ease-in-out transform py-4 bg-violet-500 rounded-xl text-white font-bold text-lg">
                        Sign in
                    </button>
                ...
                <div className="mt-8 flex justify-center items-center">
                    ...
                    <button onClick={handleSubmit} className="ml-2 font-medium text-base text-violet-500">
                        Sign up
                    </button>
                </div>
            </div>
